    ...
    (() => {
        ...
        var n = function (t, e) {
                t.forEach(function (t) {
                    this[t] = function () {
                        ...
                        i && (e._pendingRequests[n] = i.bind(this)), e._target.postMessage({ type: 'api.request', instanceId: e.getIdentifier(), requestId: n, member: t, arguments: s }, e.getDomain());
                    };
                }, this),
        ...
        s.prototype = {
            ...
            use: function (t, e) {
                ...
                (this._pendingRequests[i] = function (t, i, s) {
                    ...
                    this._target.postMessage({ type: 'api.initialize', requestId: i, name: t, instanceId: this._instanceId }, this._domain);
            },
                            ...
                            if (-1 !== t.indexOf(i))
                                if ('api.event' === i) {
                                    ...
                                    if (this._eventListeners['*'] || this._eventListeners.all)
                                        return void ['*', 'all'].forEach(function (t) {
        ...
        var d = function (t, e) {
            ...
            'object' === i(t) && ((s = t), (n = null)),
                ...
                this._target.id && (this._apiId += '_' + this._target.id),
                this._target.allow || (this._target.allow = 'vr; autoplay; fullscreen'),
                (this._client = void 0),
                (this._options = void 0),
                (this._domain = 'sketchfab.com'),
                (this._domain = 'same-as-current' === this._domain ? window.location.hostname : this._domain),
        ...
        d.prototype = {
            _urlOptionsDict: { skfb_api_version: { default: '1.12.1', type: 'string' } },
            ...
            _initializeAPIEmbed: function (t) {
                if (t.data && t.data.instanceId && this._apiId === t.data.instanceId && 'api.ready' === t.data.type && this._target.src) {
                    ...
                    (e = 'https://' + e[2]),
                        this._client &&
                            (console.log('reusing a Sketchfab instance for multiple client is not supported, please create a new sketchfab instance'), window.removeEventListener('message', this._client._serverReceiveMessageBinded)),
            ...
            _realInit: function () {
                this._initializeAPIEmbedBinded || (this._initializeAPIEmbedBinded = this._initializeAPIEmbed.bind(this)),
